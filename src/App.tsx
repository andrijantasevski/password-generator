...
function App() {
  const { password, generatePassword, passwordStrengthValue } = usePassword();
  ...
  return (
    <div className="main-background relative flex h-screen items-center justify-center">
      <div className="mx-auto w-11/12 lg:w-6/12 xl:w-5/12 grid grid-cols-1 gap-5">
        ...
        <PasswordForm formData={formData} setFormData={setFormData} generatePassword={generatePassword} copyPassword={copyPassword} generatedPassword={password} passwordLength={passwordLength} setPasswordLength={setPasswordLength} passwordStrengthValue={passwordStrengthValue} />
      </div>
